...
<<<<<<< HEAD:altk/pre_tool/reflection/refraction/docs/07.-Offline-Analysis.md
<<<<<<<< HEAD:docs/components/refraction/07.-Offline-Analysis.md
...
>>>>>>>> f8aea99 (Move pre-tool-reflection components to pre tool lifecycle stage under reflection):altk/pre_tool/reflection/refraction/docs/07.-Offline-Analysis.md
=======
are [here](../../../../tests/utils/refraction/tools/sample_tool_specs.py).
>>>>>>> 5e16cd3 (Flatten pre_tool module to one level):altk/pre_tool/refraction/docs/07.-Offline-Analysis.md
