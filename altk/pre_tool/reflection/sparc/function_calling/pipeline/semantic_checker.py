...
from altk.pre_tool.reflection.sparc.function_calling.pipeline.adapters import (
    BaseAdapter,
    OpenAIAdapter,
)
from altk.pre_tool.reflection.sparc.function_calling.pipeline.types import (
    ToolSpec,
    ToolCall,
    TransformResult,
...
from altk.pre_tool.reflection.sparc.function_calling.pipeline.transformation_prompts import (
